...
Please log in to Active Pay by clicking <a href="${baseURL}/filenet/apdocument.do?wobNumber=${document.wobNumber}&amp;ceDocumentId=${document.ceDocumentId}">here</a> to view the request. 
					<table>
						<tr>
