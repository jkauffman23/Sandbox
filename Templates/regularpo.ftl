...
<table style="width: 100%">
	...
	<div style="float: left">
			<table>
				<tr style="margin:0px;padding:0px;">
					<td style="font-size: 60px; font-weight: 500;">COMPANY</td>
						<td>
							<div style="font-size: 18px; font-weight: 500;">LOGO 
								</div>
	...
	<tr>
		...
		<td>
			...
			<span style="font-family: 'Lucida Sans'; font-size: 12px ; float:right;">
				...
				<span style="font-family: 'Lucida Sans'; font-size: 12px ; float:left;"> No&nbsp;&nbsp;&nbsp;:    <#if document.poId?exists>${document.poId}</#if>   &nbsp;&nbsp;&nbsp; <br>
				Date:  <#if document.date?exists>${document.date?string["MM/dd/yyyy"]}</#if>&nbsp;&nbsp;&nbsp;
				</span>
			</span>
		</td>
	...
	<td>
		<span style="font-family: 'Lucida Sans'; font-size: 12px ; float:left;"> 
			Confirmed to: <#if document.tbdString24?exists>${document.tbdString24}</#if><br />
...
<table style="width: 100%;  border: 1px solid #000000;">
	...
	<#list document.documentLines as docline>
				<tr>
					...
					<td style="border-right: 1px dotted;text-align:Left;vertical-align:top;"><span id="lines"><#if docline.itemDescription?exists>${docline.itemDescription}</#if></span></td>
					...
					<td style="border-right: 1px dotted;text-align:right;vertical-align:top;"><span id="lines"><#if docline.unitPrice?exists>${docline.unitPrice?string(",############0.00")}</#if> <#if document.currencyId?exists>${document.currencyId}<#else>${""}</#if></span>&nbsp;</td>
					<td style="border-right: 1px dotted;text-align:right;vertical-align:top;"><span id="lines"><#if docline.lineTotal?exists>${docline.lineTotal?string(",############0.00")}</#if> <#if document.currencyId?exists>${document.currencyId}<#else>${""}</#if></span>&nbsp;</td>
